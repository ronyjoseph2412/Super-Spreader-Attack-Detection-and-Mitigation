...
class DigestController():
    ...
    def recv_msg_digest(self, msg):
        ...
        for sub_message in range(num):
            ...
            self.controller.table_add("whitelist", "NoAction", [str(ipaddress.IPv4Address(src))])
            msg = msg[offset:]
    ...
    def run_digest_loop(self):
        ...
        while True:
            ...
            print "Time taken by TCP Handshake between switch and controller : ",time.time()-start_time
